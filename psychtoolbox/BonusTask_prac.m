function BonusTask_prac(subjectnum)
...
try
    ...
    instruction_msg = sprintf('Assuming that you have earned enough practice points, now practice the bonus game.');
    Screen('TextSize', window, floor((25*scale_res(2))));
    longest_msg = 'On each trial, you will see a letter followed by two decks from the Letter Game practice.';
    ...
    letters = {'B', 'B', 'B', 'H', 'H', 'H', 'S', 'S', 'S', 'Y', 'Y', 'Y'};
